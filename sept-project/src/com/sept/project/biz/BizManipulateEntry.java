...
import com.sept.db.dba.object.ManipulateAble;
...
import com.sept.project.trace.RequestTracer;

public class BizManipulateEntry extends ManipulateAble implements BusinessAble {
	private Map<String, Method> handlerMethodMap = new HashMap<String, Method>();

	public BizManipulateEntry() {
		super();
	...
	public DataObject doMethod(Class<? extends BusinessAble> classz, String methodName, DataObject para)
		...
		BizQueryEntry entry = null;
		Method method;
		DataObject returnPara = null;
		try {
			entry = (BizQueryEntry) classz.newInstance();
			// 再执行指定方法
