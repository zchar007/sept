...
public class DataTableColumns {
	private HashMap<String, DataTableColumn> hmClumns;
	private ArrayList<String> alKeys;

	public DataTableColumns() {
		hmClumns = new HashMap<String, DataTableColumn>();
		alKeys = new ArrayList<String>();
	}

	public boolean addColumn(int columnIndex, DataTableColumn column) {
		if (columnIndex < 0) {
			columnIndex = 0;
		}
		// 如果存在，则覆盖
	...
	public boolean addColumn(int columnIndex, String name, String showName, String defaultValue) {
		if (columnIndex < 0) {
			columnIndex = 0;
		}
		DataTableColumn column = new DataTableColumn(name, showName, defaultValue);
	...
	public DataTableColumn getColumn(int columnIndex) {
	...
	private boolean checkColumn(DataTableColumn column) {
