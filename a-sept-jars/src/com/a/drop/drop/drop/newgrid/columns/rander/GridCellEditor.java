...
//
	public GridCellEditor(GridColumn component) {
		...
		if (component instanceof TextColumn) {
		...
		} else if (component instanceof DropdownColumn) {
	...
	public void initGridCellEditor(final JComboBox<?> comboBox) {
		...
		delegate = new EditorDelegate() {
			...
			public void setValue(Object value) {
				...
				comboBox.setSelectedItem(((DropdownColumn)editObject).dealValue(value));
			}
		...
		if (editorComponent instanceof JCheckBox) {
			...
			if (null == buttonListener) {
				buttonListener = new ActionListener() {
					@Override
					public void actionPerformed(ActionEvent e) {
						button.getTableCellButtonAction().actionPerformed(e, table.getSelectedRow());
					}
				};
