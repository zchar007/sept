package com.sept.datastructure.office.poi;
...
//		System.out.println(ds.get(3));
	 ...
	 * @throws AppException
	 */
	public static final Workbook getExcel(File file) throws AppException {
		if (!isExcel(file)) {
	 ...
	 * @throws AppException
	 */
	public static final Workbook getExcel(byte[] bt) throws AppException {
		InputStream is = null;
		try {
