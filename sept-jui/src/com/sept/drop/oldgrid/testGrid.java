...
public class testGrid extends JFrame {
	...
	public testGrid() throws AppException {
		...
		grid.addColumn(new GridColumn("是不是学生", "sbsxs", GridColumn.COLUMNTYPE_CHECKBOX, "false", null, false));
		...
		grid.addColumn(new GridColumn("是不是学生", "sbsxs2", GridColumn.COLUMNTYPE_CHECKBOX, "false", null, false));
