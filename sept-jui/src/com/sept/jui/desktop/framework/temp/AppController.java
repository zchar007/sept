...
/**
 * 本类负责： 1.协调tree和panel的显示问题 2.增加设置app文件夹 3.设置指定app文件夹下的app
 * 
 * @author zchar
 *
 */
public class AppController {
	...
	public AppController(AppFrame fr) {
		...
		try {
			root = new AppModel("根节点", ImageIO.read(f_root), null, null, null);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static JFrame getJFrameFromComponent(Component component) throws Exception {
		...
		if (component_temp == null) {
			throw new Exception("向上溯源没有找到JFrame!!");
		}
