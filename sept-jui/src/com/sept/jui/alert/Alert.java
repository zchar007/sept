...
public final class Alert {
	...
	public final static void alertQuestion(String message) {
		JOptionPane.showMessageDialog(null, message, "系统信息", JOptionPane.QUESTION_MESSAGE);

	}

	public final static String alertSelect(String title, String message, Object[] select) {
	 ...
	 * @since V1.0
	 */
	public final static String alertSelectFile(String defulPath, int selectFileType) {
		JFileChooser jf = new JFileChooser();
		jf.setFileSelectionMode(selectFileType == SelectFileType_DIRECTORIES_ONLY
