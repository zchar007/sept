...
public class testGrid extends JFrame {
	...
	public testGrid() throws AppException {
		...
		grid.addColumn(new GridColumn("姓名", "xm", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("年龄", "nl", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("家庭住址", "jtzz", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("电话", "dh", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("是不是学生", "sbsxs", GridColumn.COLUMNTYPE_CHECKBOX, "true", null, true));
		grid.addColumn(new GridColumn("年级", "nj", GridColumn.COLUMNTYPE_DROPDOWN, "1", "1:一年级,2:二年级,3:三年级", true));
		grid.addColumn(new GridColumn("姓名", "xm2", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("年龄", "nl2", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("家庭住址", "jtzz2", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("电话", "dh2", GridColumn.COLUMNTYPE_STRING, "张三", null, true));
		grid.addColumn(new GridColumn("是不是学生", "sbsxs2", GridColumn.COLUMNTYPE_CHECKBOX, "true", null, true));
		grid.addColumn(new GridColumn("年级", "nj2", GridColumn.COLUMNTYPE_DROPDOWN, "1", "1:一年级,2:二年级,3:三年级", true));
