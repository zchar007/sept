	...
	public void putAndAddMessage(String key, Object value) {
		synchronized (messPool) {
			if (value instanceof Integer) {
				...
				this.messPool.put(key, (int) this.messPool.get(key)
						+ (int) value);
			}
			if (value instanceof Double) {
				...
				this.messPool.put(key, (double) this.messPool.get(key)
						+ (double) value);
			}
			if (value instanceof Float) {
				...
				this.messPool.put(key, (float) this.messPool.get(key)
						+ (float) value);
			}
			if (value instanceof Long) {
				...
				this.messPool.put(key, (long) this.messPool.get(key)
						+ (long) value);
			}
			if (value instanceof String) {
				...
				this.messPool.put(key, (String) this.messPool.get(key)
						+ (String) value);
			}
