...
public class TypeUtil {
	...
	/**
	 * DataStore DataObject 存储数据时获取value类型</br> 数字型参数转成Number 日期型转成
	 * java.util.Date
	 * 
	 * @param 关键字
	 *            说明
	 ...
	 * @throws AppException
	 */
	public static Object getValueByType(String type, Object o)
			throws AppException {
		try {
	...
	public static DataObject objectToDataObject(Object o) throws AppException {
		...
		if (o instanceof DataObject || cname.equals(DataObject.class.getName())) {
			return (DataObject) o;
		} else if (o instanceof String || cname.equals("java.lang.String")
				|| o instanceof StringBuffer
				|| cname.equals("java.lang.StringBuffer")
				|| o instanceof StringBuilder
				|| cname.equals("java.lang.StringBuilder")) {
	...
	public static int objectToInt(Object o) {
		...
		if (o instanceof Date || cname.equals("java.util.Date")) {
			...
			return Integer
					.parseInt(DateUtil.formatDate((Date) o, "yyyyMMddHH"));
		}
		if (o instanceof java.sql.Date || cname.equals("java.sql.Date")) {
			Date d = new Date(((java.sql.Date) o).getTime());
	...
	public static float objectToFloat(Object o) {
		...
		if (o instanceof Date || cname.equals("java.util.Date")) {
			...
			return Float.parseFloat(DateUtil.formatDate((Date) o,
					"yyyyMMddHHmmss"));
		}
		if (o instanceof java.sql.Date || cname.equals("java.sql.Date")) {
			Date d = new Date(((java.sql.Date) o).getTime());
	...
	public static long objectToLong(Object o) {
		...
		if (o instanceof Date || cname.equals("java.util.Date")) {
			...
			return Long.parseLong(DateUtil.formatDate((Date) o,
					"yyyyMMddHHmmss"));
		}
		if (o instanceof java.sql.Date || cname.equals("java.sql.Date")) {
			Date d = new Date(((java.sql.Date) o).getTime());
	...
	public static double objectToDouble(Object o) {
		...
		if (o instanceof Date || cname.equals("java.util.Date")) {
			...
			return Double.parseDouble(DateUtil.formatDate((Date) o,
					"yyyyMMddHHmmss"));
		}
		if (o instanceof java.sql.Date || cname.equals("java.sql.Date")) {
			Date d = new Date(((java.sql.Date) o).getTime());
	...
	public static void main(String[] args) throws AppException {
		Date str = (Date) getValueByType(TypeUtil.DATE, new java.sql.Timestamp(
				new Date().getTime()));
