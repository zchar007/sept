...
public class DataFormat
{
  ...
  public static String formatInt(Integer vInt)
    throws AppException
  {
    if (vInt == null) {
    //  Alert.isNull("????????????");
  ...
  public static String formatInt(int vInt, String vFormat)
    throws AppException
  {
  ...
  public static String formatLong(long vLong, String vFormat)
    throws AppException
  {
    if ((vFormat == null) || (vFormat.length() == 0)) {
  ...
  public static String formatDouble(double vDouble)
    throws AppException
  {
    return formatDouble(vDouble, 2);
  }
  
  public static String formatDouble(double vDouble, int n)
    throws AppException
  {
    return formatDouble(new Double(vDouble), n);
  }
  
  public static String formatDouble(String vDouble)
    throws AppException
  {
    return formatDouble(vDouble, 2);
  }
  
  public static String formatDouble(String vDouble, int n)
    throws AppException
  {
    try
    {
  ...
  public static String formatDouble(double vDouble, String vFormat)
    throws AppException
  {
    if ((vFormat == null) || (vFormat.length() == 0)) {
  ...
  public static String formatDouble(String vDouble, String vFormat)
    throws AppException
  {
    try
    {
  ...
  {
    if (("1".equals(vString)) || ("true".equalsIgnoreCase(vString)) || ("yes".equalsIgnoreCase(vString)) || ("y".equalsIgnoreCase(vString))) {
      return "true";
    }
    return "false";
  }
  ...
  public static String formatNumber(double vDouble, String vFormat)
    throws AppException
  {
    return formatDouble(vDouble, vFormat);
  }
  
  public static String formatNumber(double vDouble)
    throws AppException
  {
    return formatDouble(vDouble);
  }
  
  public static String formatNumber(int vInt)
    throws AppException
  {
    return formatInt(vInt);
  }
  
  public static String formatNumber(int vInt, String vFormat)
    throws AppException
  {
    return formatInt(vInt, vFormat);
  }
  
  public static String numberToChinese(long vMoney)
    throws AppException
  {
 ...
 //   Alert.FormatError("??[" + vMoney + "]??????????????????????????");
  ...
  public static String numberToChinese(double vMoney)
    throws AppException
  {
    int leng = CHINESE_CARRY.length > maxMoneyLength ? maxMoneyLength : CHINESE_CARRY.length;
    if (Math.abs(vMoney) < Math.pow(10.0D, leng))
  ...
  private static String numberToChinese(String vMoneyString)
    throws AppException
  {
  ...
  public static String formatValue(Object value, String mask)
    throws AppException
  {
    if (value == null) {
      return "";
  ...
  public static String formatValueWithoutMask(Object value)
    throws AppException
  {
