package com.sept.support.excel;
...
public class ExcelUtil {
	 ...
	 * @since V1.0
	 */
	public static byte[] getExcelFromJSON(ExcelColumns excelColumns,
	 ...
	 * @since V1.0
	 */
	public static byte[] getExcelFromXML(ExcelColumns excelColumns,
			String xmlStr) throws AppException {
	 ...
	 * @since V1.0
	 */
	public static byte[] getExcelFromDataStore(ExcelColumns columns,
			DataStore datas) throws AppException {
		try {
