...
import com.sept.framework.taglib.sept.layout.layoutCell.LayoutCellImpl;

public class LayoutImpl extends AbstractImpl {
	...
	public String genHTML() throws JspException {
		...
		for (int i = 0; i < children.size(); i++) {
			if (children.get(i) instanceof LayoutCellImpl) {
