...
public class AccordionImpl extends AbstractImpl {
	...
	public String genHTML() throws JspException {
		...
		html.append("<div id=\"sept-name-" + this.getStringPara("name")
				+ "\" class=\"easyui-accordion\" data-options=\""
				+ this.getEUIOptions() + "\" fit=\"" + fit + "\" style=\""
				+ sizeStr + "\">\n");

		ArrayList<AbstractImpl> children = this.getChildren();
		for (int i = 0; i < children.size(); i++) {
			if (children.get(i) instanceof AccordionCellImpl) {
