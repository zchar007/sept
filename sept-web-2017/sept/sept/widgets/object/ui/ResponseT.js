// 创建一个Response
/**
 * childpage:iframe 的id var frames = document.getElementById("childpage");
 * //alert(frames); function sys_click(e) {
 * 
 * if (e.name == "xyb") { if(frames.contentWindow.goNext()){
 * WorkFlowUtil.goNext('<%=caseid%>'); } }
 * 
 * @param title
 * @param requestUrl
 * @param width
...
Response.prototype.open = function() {
	...
	$("div.__main__container__").append(panelHtml);
	...
	var data = AjaxUtil.ajaxRequest(this.url);
	this.html += data;
